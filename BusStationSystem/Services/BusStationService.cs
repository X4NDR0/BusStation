    ...
    public class BusStationService
    {
        ...
        private void EditTransportaionCompany()
        {
            ...
            if (CheckID != null)
            {
                ...
                Console.Write("Enter new name of the transportaion company:");
        ...
        private void RemoveTicket()
        {
            ...
            Int32.TryParse(Console.ReadLine(), out int ticketID);

            Ticket CheckAndRemove = ticketList.Where(h => h.TicketId == ticketID).FirstOrDefault();
